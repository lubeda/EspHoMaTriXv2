...
This automation example displays states with icons and a rainbow colored text for state changes of multiple icons.
The icon is selected by the `trigger.id`, the text is dynamically built by the triggered state.
...
- If you remove icons from your list, old automations will probably use these icons, resulting in displaying the
  default icon!
